...
export type RouletteEvent =
  ...
  | { readonly type: 'PLAYER_LEFT'; readonly seatIndex: SeatIndex; readonly playerId: PlayerId; readonly bankroll: Chips }
  | {
  ...
  | { readonly type: 'BET_REMOVED'; readonly seatIndex: SeatIndex; readonly betId: BetId; readonly refunded: Chips }
  | { readonly type: 'BETS_CLEARED'; readonly seatIndex: SeatIndex; readonly refunded: Chips }
